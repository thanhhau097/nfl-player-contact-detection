...
### Another command
```
python -m torch.distributed.launch --nproc_per_node 2 train.py --output_dir ./outputs_heatmap/ --num_train_epochs 10 --do_train --do_eval --metric_for_best_model eval_matthews_corrcoef --overwrite_output_dir --per_device_train_batch_size 16 --model_name resnet50 --fold 0 --dataloader_num_workers 32 --evaluation_strategy steps  --eval_steps 5000 --save_strategy steps --save_steps 5000 --learning_rate 1e-3
```